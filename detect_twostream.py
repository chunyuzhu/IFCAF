...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/data/lzn/INFAF/runs/best_train/best_M3FD/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='/data/lzn/dataset/M3FD/M3FD_Detection/vi/', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/data/lzn/dataset/M3FD/M3FD_Detection/ir/', help='source')  # file/folder, 0 for webcam
